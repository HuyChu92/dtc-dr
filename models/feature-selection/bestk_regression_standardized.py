...
def calculate_best_regression_model():
    ...
    for col in y.columns:
        col_results = {"r2_scores": [], "selected_feature_indices": []}
        ...
        for index in range(1, len(X.columns) + 1):
            ...
            X_train_selected = k_best.fit_transform(X_train_std, y_train[col])
            X_test_selected = k_best.transform(X_test_std)
            ...
            col_results["r2_scores"].append(r2)
...
with open('regression_results_standardized.json', 'w') as json_file:
